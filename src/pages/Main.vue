  ...
  <el-row class="container">
    <el-col :span="28" class="header">
      <el-col :span="10" class="logo">
        <img src="../assets/logo.png" /><span>UangUang management system</span>
      </el-col>
      <el-col :span="8" class="userinfo">
        ...
        <span :span="8" class="changeLanguage"><span> <span :class="{clickOn:changeCn}" @click="cn">中文</span> <span id="middle">/</span> <span :class="{clickOn:changeInn}" @click="inn">indonesian</span></span></span>
      </el-col>
    </el-col>
