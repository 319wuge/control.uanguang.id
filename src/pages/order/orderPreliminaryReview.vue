      ...
      <div class="containers">
        <div class="asides">
          ...
          <table v-if='studentSeen' border='.1px' width="100%" style="table-layout:fixed;">
            ...
            <tr>
              <td>父亲手机号</td>
              <td>{{hideUserPhone(baseInfList.fatherMobile)}}</td>
            </tr>
            <tr>
              <td>父亲职位</td>
            ...
            <tr>
              <td>母亲手机号</td>
              <td>{{hideUserPhone(baseInfList.motherMobile)}}</td>
            </tr>
            <tr>
              <td>母亲职位</td>
    ...
    <div class="containers" v-if="workerSeen">
      <div class="asides">
        ...
        <table v-if="workerSeen" border='.1px' width="100%" style="table-layout:fixed;">
          ...
          <tr>
            <td>公司电话</td>
            <td>{{hideUserPhone(jobInfList.companyPhone)}}</td>
          </tr>
        </table>
      </div>
      <div class="mains">
  ...
  <div class="containers">
    <div class="asides">
      ...
      <table border='.1px' width="100%" style="table-layout:fixed;">
        ...
        <tr>
          <td>联系人电话1</td>
          <td>{{hideUserPhone(connectInfList.contactsMobile1)}}</td>
        </tr>
        <tr>
          <td>联系人姓名2</td>
        ...
        <tr>
          <td>联系人电话2</td>
          <td>{{hideUserPhone(connectInfList.contactsMobile2)}}</td>
        </tr>
        <tr>
          <td>备用联系人电话</td>
          <td>{{hideUserPhone(connectInfList.alternatePhoneNo)}}</td>
        </tr>
      </table>
    </div>
    <div class="mains">
...
<el-form id="btnForm">
  <el-form-item align="right">
    <el-button @click="dialogVisible1 = true" type="primary">建议拒绝</el-button>
    <el-button @click="dialogVisible = true" type="primary">建议通过</el-button>
  </el-form-item>
</el-form>
<el-dialog
title="建议通过"
