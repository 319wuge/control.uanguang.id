...
<template>
  <section class="orderBox">
      ...
      <div class="containers">
        ...
        <div class="mains">
          <div class="check_rule">
            ...
            <div class="question_radio">
              <div class="question_text">9、出生年月为偶数但身份证背景为红色/出生年月为奇数但身份证背景为蓝色？</div>
              <div class="radio_box">
      ...
      <div class="containers">
        ...
        <div class="mains">
          <div class="check_rule">
            ...
            <div class="question_radio">
              <div class="question_text">1、手持照片看不清人脸（非身份证）？ </div>
              <div class="radio_box">
                <el-checkbox :disabled="faceCheckShow" v-model="faceCheckRuleList[0].ruleResult"></el-checkbox>
              </div>
            </div>
            <div class="question_radio">
              <div class="question_text">2、手持照片人脸（非身份证）与活体人脸不一致？ </div>
              <div class="radio_box">
                <el-checkbox :disabled="faceCheckShow" v-model="faceCheckRuleList[1].ruleResult"></el-checkbox>
              </div>
            </div>
            <div v-if ="flager">
              <div class="question_radio">
                <div class="question_text">3、活体识别与驾驶证照片不一致？ </div>
                <div class="radio_box">
                  <el-checkbox :disabled="faceCheckShow" v-model="faceCheckRuleList[2].ruleResult"></el-checkbox>
                </div>
              </div>
              <div class="question_radio">
                <div class="question_text">4、无法判断驾驶证照片与活体识别是否一致？ </div>
                <div class="radio_box">
    ...
    <el-row>
      ...
      <el-row>
        <span class="two-title">公司与联系人电核 &nbsp;<el-button v-if="comPhoneCheckStartVif" @click="comPhoneCheckStart" type="primary">开始</el-button></span>
        <template>
          <el-table
        ...
        width="25%">
          <el-row>
            <el-radio  v-model="smallCompany" label="1">稍后再拨</el-radio>
            <el-radio v-if="judgeWhichSamllDialog == '1'" v-model="smallCompany" label="2">第一联系人</el-radio>
            <el-radio v-if="judgeWhichSamllDialog == '2'" v-model="smallCompany" label="2">第二联系人</el-radio>
        ...
        <el-dialog
          ...
          <el-col>
            <template v-if="dialogType === '2'">
              <span>问题一：请问{{baseInfList.realName}} 是在贵公司工作吗？</span><br/>
              <el-radio :disabled="companyDisabled" v-model="dialogResultRadio1" label="1" @change.native="judgeResult">在职</el-radio>
              <el-radio :disabled="companyDisabled" v-model="dialogResultRadio1" label="2" @change.native="judgeResult">已离职/不在该公司工作</el-radio>
          ...
          <el-col>
            <template v-if="dialogType === '2'">
              ...
              <el-radio :disabled="companyDisabled" v-model="dialogResultRadio2" label="1">未知</el-radio>
              <el-radio :disabled="companyDisabled" v-model="dialogResultRadio2" label="2">3个月以下</el-radio>
              <el-radio :disabled="companyDisabled" v-model="dialogResultRadio2" label="3">3-6个月</el-radio>
              <el-radio :disabled="companyDisabled" v-model="dialogResultRadio2" label="4">6-12个月</el-radio>
              <el-radio :disabled="companyDisabled" v-model="dialogResultRadio2" label="5">1年以上</el-radio>
            </template>
          </el-col>
          <el-col v-if="dialogType === '2'">
            <template>
              <span>问题三：请问您知道是否有别的公司向他催款吗？</span><br/>
              <el-radio :disabled="companyDisabled" v-model="dialogResultRadio3" label="1" @change.native="judgeResult">未知</el-radio>
              <el-radio :disabled="companyDisabled" v-model="dialogResultRadio3" label="2" @change.native="judgeResult">对方反馈用户资质很差/多次被催收等</el-radio>
              <el-radio :disabled="companyDisabled" v-model="dialogResultRadio3" label="3" @change.native="judgeResult">无</el-radio>
            </template>
          </el-col>
          <!--<el-col v-if="dialogType === '2'">-->
          <!--<template>-->
          ...
          <el-col>
            <template v-if="dialogType === '4'">
              ...
              <el-radio :disabled="companyDisabled" v-model="dialogResultRadio5" label="1">不认识</el-radio>
              <el-radio :disabled="companyDisabled" v-model="dialogResultRadio5" label="2">父母</el-radio>
              <el-radio :disabled="companyDisabled" v-model="dialogResultRadio5" label="3">兄弟姐妹</el-radio>
              <el-radio :disabled="companyDisabled" v-model="dialogResultRadio5" label="4">孩子</el-radio>
              <el-radio :disabled="companyDisabled" v-model="dialogResultRadio5" label="5">朋友</el-radio>
              <el-radio :disabled="companyDisabled" v-model="dialogResultRadio5" label="6">同事</el-radio>
              <el-radio :disabled="companyDisabled" v-model="dialogResultRadio5" label="7">客户</el-radio>
              <el-radio :disabled="companyDisabled" v-model="dialogResultRadio5" label="8">其他</el-radio>
            </template>
          </el-col>
          <!--<el-col>-->
          <!--<template v-if="dialogType === '4'">-->
          ...
          <el-col v-if="dialogType === '4'">
            <template>
              ...
              <el-radio :disabled="companyDisabled" v-model="dialogResultRadio7" label="1" @change.native="judgeResult">未知</el-radio>
              <el-radio :disabled="companyDisabled" v-model="dialogResultRadio7" label="2" @change.native="judgeResult">用户无工作</el-radio>
              <el-radio :disabled="companyDisabled" v-model="dialogResultRadio7" label="3" @change.native="judgeResult">有工作</el-radio>
            </template>
          </el-col>
          <el-col>
            <template v-if="dialogType === '4'">
              <span>问题三：他这份工作大概做了多久了？</span><br/>
              <el-radio :disabled="companyDisabled" v-model="dialogResultRadio8" label="1">未知</el-radio>
              <el-radio :disabled="companyDisabled" v-model="dialogResultRadio8" label="2">3个月以下</el-radio>
              <el-radio :disabled="companyDisabled" v-model="dialogResultRadio8" label="3">3-6个月</el-radio>
              <el-radio :disabled="companyDisabled" v-model="dialogResultRadio8" label="4">6个月-1年</el-radio>
              <el-radio :disabled="companyDisabled" v-model="dialogResultRadio8" label="5">1年以上</el-radio>
            </template>
          </el-col>
          <el-col v-if="dialogType === '4'">
            <template>
              <span>问题四：请问您知道是否有别的公司向他催款吗？</span><br/>
              <el-radio :disabled="companyDisabled" v-model="dialogResultRadio9" label="1" @change.native="judgeResult">未知</el-radio>
              <el-radio :disabled="companyDisabled" v-model="dialogResultRadio9" label="2" @change.native="judgeResult">无</el-radio>
              <el-radio :disabled="companyDisabled" v-model="dialogResultRadio9" label="3" @change.native="judgeResult">建议不要借钱给用户/用户存在逾期的情况/被多家公司催款</el-radio>
            </template>
          </el-col>
          <!--<el-col v-if="dialogType === '4'">-->
          <!--<template>-->
          ...
          <el-col>
            <template v-if="dialogType === '6'">
              ...
              <el-radio :disabled="companyDisabled" v-model="dialogResultRadio11" label="6" @change.native="judgeResult">同事</el-radio>
              <el-radio :disabled="companyDisabled" v-model="dialogResultRadio11" label="7" @change.native="judgeResult">客户</el-radio>
              <el-radio :disabled="companyDisabled" v-model="dialogResultRadio11" label="8" @change.native="judgeResult">其他</el-radio>
            </template>
          </el-col>
          <!--<el-col>-->
          <!--<template v-if="dialogType === '6'">-->
          ...
          <el-col v-if="dialogType === '6'">
            <template>
              <span>问题二：请问您知道他现在有工作吗？</span><br/>
              <el-radio :disabled="companyDisabled" v-model="dialogResultRadio13" label="1" @change.native="judgeResult">未知</el-radio>
              <el-radio :disabled="companyDisabled" v-model="dialogResultRadio13" label="2" @change.native="judgeResult">用户无工作</el-radio>
              <el-radio :disabled="companyDisabled" v-model="dialogResultRadio13" label="3" @change.native="judgeResult">有工作</el-radio>
            </template>
          </el-col>
          <el-col>
            <template v-if="dialogType === '6'">
              <span>问题三：他这份工作大概做了多久了？</span><br/>
              <el-radio :disabled="companyDisabled" v-model="dialogResultRadio14" label="1">未知</el-radio>
              <el-radio :disabled="companyDisabled" v-model="dialogResultRadio14" label="2">3个月以下</el-radio>
              <el-radio :disabled="companyDisabled" v-model="dialogResultRadio14" label="3">3-6个月</el-radio>
              <el-radio :disabled="companyDisabled" v-model="dialogResultRadio14" label="4">6个月-1年</el-radio>
              <el-radio :disabled="companyDisabled" v-model="dialogResultRadio14" label="5">1年以上</el-radio>
            </template>
          </el-col>
          <el-col v-if="dialogType === '6'">
            <template>
              <span>问题四：请问您知道是否有别的公司向他催款吗？</span><br/>
              <el-radio :disabled="companyDisabled" v-model="dialogResultRadio15" label="1" @change.native="judgeResult">未知</el-radio>
              <el-radio :disabled="companyDisabled" v-model="dialogResultRadio15" label="2" @change.native="judgeResult">无</el-radio>
              <el-radio :disabled="companyDisabled" v-model="dialogResultRadio15" label="3" @change.native="judgeResult">建议不要借钱给用户/用户存在逾期的情况/被多家公司催款</el-radio>
            </template>
          </el-col>
          <!--<el-col v-if="dialogType === '6'">-->
          <!--<template>-->
          ...
          <el-col>
            <div class="grid-content bg-purple"><span>电核结果：</span>
              <template v-if="dialogType === '1'">
                ...
                <el-radio :disabled="companyDisabled" v-model="dialogResultRadio21" label="2" @change.native="setSmallDialog(1)">无人接听/通话中</el-radio>
              ...
              <template v-if="dialogType === '2'">
                ...
                <el-radio :disabled="companyDisabled2" v-model="dialogResultRadio22" label="2" @change.native="getCurrentRow">稍后再拨</el-radio>
                <el-radio :disabled="companyDisabled2" v-model="dialogResultRadio22" label="3" @change.native="getCurrentRow">信息存疑</el-radio>
                <el-radio :disabled="companyDisabled2" v-model="dialogResultRadio22" label="4" @change.native="getCurrentRow">拒绝</el-radio>
                <el-radio :disabled="companyDisabled2" v-model="dialogResultRadio22" label="5" @change.native="getCurrentRow">通过</el-radio>
                <el-radio :disabled="companyResultDisabled" v-model="dialogResultRadio221" label="6">优秀</el-radio>
                <el-radio :disabled="companyResultDisabled" v-model="dialogResultRadio221" label="7">良好</el-radio>
                <el-radio :disabled="companyResultDisabled" v-model="dialogResultRadio221" label="8">一般</el-radio>
              </template>
              <template v-if="dialogType === '3'">
                <el-radio :disabled="companyDisabled" v-model="dialogResultRadio23" label="1">空号/不存在/无效/错误</el-radio>
                <el-radio :disabled="companyDisabled" v-model="dialogResultRadio23" label="2" @change.native="setSmallDialog(2)">无人接听/通话中</el-radio>
                <el-radio :disabled="companyDisabled" v-model="dialogResultRadio23" label="3">呼叫转移/呼入限制</el-radio>
                <el-radio :disabled="companyDisabled" v-model="dialogResultRadio23" label="4" @change.native="setSmallDialog(2)">不在服务区</el-radio>
                <el-radio :disabled="companyDisabled" v-model="dialogResultRadio23" label="5" @change.native="setSmallDialog(2)">关机</el-radio>
                <el-radio :disabled="companyDisabled" v-model="dialogResultRadio23" label="6">停机/已欠费</el-radio>
              </template>
              <template v-if="dialogType === '4'">
                <el-radio :disabled="companyDisabled4" v-model="dialogResultRadio24" label="1">拒绝回答</el-radio>
                <el-radio :disabled="companyDisabled4" v-model="dialogResultRadio24" label="2">稍后再拨</el-radio>
                <el-radio :disabled="companyDisabled4" v-model="dialogResultRadio24" label="3">信息存疑</el-radio>
                <el-radio :disabled="companyDisabled4" v-model="dialogResultRadio24" label="4">拒绝</el-radio>
                <el-radio :disabled="companyDisabled4" v-model="dialogResultRadio24" label="5">通过</el-radio>
              </template>
              <template v-if="dialogType === '5'">
                <el-radio :disabled="companyDisabled" v-model="dialogResultRadio25" label="1">空号/不存在/无效/错误</el-radio>
                <el-radio :disabled="companyDisabled" v-model="dialogResultRadio25" label="2" @change.native="setSmallDialog(3)">无人接听/通话中</el-radio>
                <el-radio :disabled="companyDisabled" v-model="dialogResultRadio25" label="3">呼叫转移/呼入限制</el-radio>
                <el-radio :disabled="companyDisabled" v-model="dialogResultRadio25" label="4" @change.native="setSmallDialog(3)">不在服务区</el-radio>
                <el-radio :disabled="companyDisabled" v-model="dialogResultRadio25" label="5" @change.native="setSmallDialog(3)">关机</el-radio>
                <el-radio :disabled="companyDisabled" v-model="dialogResultRadio25" label="6">停机/已欠费</el-radio>
              </template>
              <template v-if="dialogType === '6'">
                <el-radio :disabled="companyDisabled6" v-model="dialogResultRadio26" label="1">拒绝回答</el-radio>
                <el-radio :disabled="companyDisabled6" v-model="dialogResultRadio26" label="2">稍后再拨</el-radio>
                <el-radio :disabled="companyDisabled6" v-model="dialogResultRadio26" label="3">信息存疑</el-radio>
                <el-radio :disabled="companyDisabled6" v-model="dialogResultRadio26" label="4">拒绝</el-radio>
                <el-radio :disabled="companyDisabled6" v-model="dialogResultRadio26" label="5">通过</el-radio>
              </template>
            </div>
          </el-col>
          <el-col>
          ...
          <span slot="footer" class="dialog-footer">
                  ...
                  <el-button v-if="!this.companyDisabled" type="primary" @click="companyReviewCommit(dialogType)">确 定</el-button>
                </span>
        </el-dialog>
        <el-dialog
          title="备注"
          ...
          <el-col>
            <div class="grid-content bg-purple"><span>电核结果：</span>
              ...
              <template v-if="dialogType === '5'">
                <el-radio v-model="dialogResultRadio" label="1">通话中/无人接听</el-radio>
                <el-radio v-model="dialogResultRadio" label="2">用户让稍后再拨</el-radio>
                <el-radio v-model="dialogResultRadio" label="3">关机</el-radio>
                <el-radio v-model="dialogResultRadio" label="4">不在服务区</el-radio>
                <el-radio v-model="dialogResultRadio" label="5">呼叫转移/呼入限制</el-radio>
                <el-radio v-model="dialogResultRadio" label="6">本人未接到电话</el-radio>
              </template>
              <template v-if="dialogType === '6'">
                <el-radio v-model="dialogResultRadio" label="1">优秀</el-radio>
                <el-radio v-model="dialogResultRadio" label="2">良好</el-radio>
      ...
      <el-row>
        <span class="two-title">本人审核 &nbsp;<el-button v-if="phoneCheckStartVif" @click="phoneCheckStart" type="primary">开始</el-button><el-button v-if="phoneCheckEndVif" @click="phoneCheckEnd" type="info">结束</el-button></span>
        <template>
          <el-table
            ...
            <el-table-column
              ...
              <template scope="scope">
                <el-button-group style="padding:5px;">
                  <el-button v-if="scope.row.remark==''" @click="phoneCheckClick(scope.row,scope.$index, 5)"  type="primary" class="company-pass" round size="medium">稍后再拨</el-button>
                  <el-button v-if="scope.row.remark==''" @click="phoneCheckClick(scope.row,scope.$index, 6)" class="company-pass" type="primary" round size="medium">通过</el-button>
                  <el-button v-if="scope.row.remark==''" @click="phoneCheckClick(scope.row,scope.$index, 7)" class="company-pass" round type="danger" size="medium">拒绝</el-button>
                </el-button-group>
              </template>
            </el-table-column>
          </el-table>
    ...
    <el-form id="btnForm">
      <el-form-item align="right">
        ...
        <el-button @click="dialogVisible1=true" type="primary">提交</el-button>
      </el-form-item>
    </el-form>
    <el-dialog
      title="拒绝订单"
  ...
  <el-button type="primary" @click="reviewRefuse">确 定</el-button>
    ...
    <el-dialog
      ...
      width="50%">
      <!-- <el-col>
        <i class="el-icon-question"></i>确定社和提交吗？
      </el-col> -->
      <!-- <el-input
      type="textarea"
      :rows="6"
...
//        comPhoneCheckEndVif: false,
        ...
        baseRuleList: [{
          ...
          },
          {
            ...
            "ruleLevel":1,
            "ruleResult":false,
            "description":'9、出生年份为偶数但身份证背景为红色/出生年份为奇数但身份证背景为蓝色？'
          },{
            "ruleCount":10,
            "ruleLevel":2,
            "ruleResult":false,
...
//        }
        ...
        this.$http.post("manage/frequentOrderUserCallRecordMongo", _data).then(response => {
          ...
          this.$http.post("manage/getTeleReviewQuestion", _data).then(response => {
            ...
            if ((res == null || res == '') && type == 2) {
              ...
              this.comPhoneCheckCurrent.teleReviewObject = '第一常用联系人';
  ...
  //                this.comPhoneCheckId = '';
                  ...
                  this.comPhoneCheckCurrent.teleReviewObject = '第二常用联系人';
  ...
  //                this.comPhoneCheckId = '';
                  ...
                  //稍后再拨
                    ...
                    this.comPhoneCheckCurrent.teleReviewObject = '所在公司';
                    this.comPhoneCheckCurrent.realName = this.jobInfList.companyName;
                    this.comPhoneCheckCurrent.mobile = this.jobInfList.companyPhone;
  //                this.comPhoneCheckId = '';
                    this.comPhoneChecktableData.push(this.comPhoneCheckCurrent);
...
//              debugger;
          ...
          } else if (row.teleReviewObject === '第一常用联系人') {
            if (type == '0') {
              this.dialogType = '3';
              this.dialogResultRadio23 = "0";
            } else {
          ...
          } else if (row.teleReviewObject === '第二常用联系人'){
            if (type == '0') {
              this.dialogType = '5';
              this.dialogResultRadio25 = "0";
            } else {
...
//            this.comPhoneCheckEndVif = false;
            ...
            if (pass == 2 || (!pass && (teleType == 1 || teleType == 2))
              || (pass == 4 && (teleType == 3 || teleType == 4))) {
              comPhoneCheckCurrent1.teleReviewObject = '第一常用联系人';
              ...
              || (pass == 4 && (teleType == 5 || teleType == 6))) {
              comPhoneCheckCurrent1.teleReviewObject = '第二常用联系人';
...
//      resetComponeCheck() {
//        this.comPhoneCheckCurrent.teleReviewObject = '';
//        this.comPhoneCheckCurrent.realName = '';
//        this.comPhoneCheckCurrent.mobile = '';
//        this.comPhoneCheckCurrent.remark = '';
//        this.comPhoneCheckCurrent.alertTime = '';
//        this.comPhoneCheckCurrent.startTime = '';
//        this.comPhoneCheckCurrent.endTime = '';
//        this.comPhoneCheckCurrent.burningTime = '';
//        this.comPhoneCheckCurrent.current = true;
//        this.comPhoneCheckCurrent.teleReviewResult = '';
//        this.comPhoneCheckCurrent.teleReviewOperationType = '';
//        this.comPhoneCheckCurrent.teleReviewResultType = '';
//      },
