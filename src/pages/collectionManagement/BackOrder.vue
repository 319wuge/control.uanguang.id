...
<template>
  <el-table :data="gridData" highlight-current-row v-loading="gridLoading" @row-click="rowClick" class="grid">
   ...
   <el-table-column label="应还时间" prop="refundTime" width="200" sortable>
    <template scope="scope">
      {{getdate(scope.row.refundTime)}}
    </template>
  </el-table-column>
  <el-table-column label="逾期天数" prop="overdueDays" width="120" sortable>
    <template scope="scope">
  ...
  <el-table-column label="最高逾期天数" prop="maxOverdueDays" width="150" sortable>
  </el-table-column>
  ...
  <el-table-column label="跟进时间" prop="followTime" width="220" sortable>
    <template scope="scope">
  ...
  <el-table-column label="借款人性别" prop="userSex" width="150" sortable>
    <template scope="scope">
      {{getChannelNametwo(scope.row.userSex)}}
    </template>
  </el-table-column>
  <el-table-column label="手机号" prop="mobile" width="220" >
  </el-table-column>
  <el-table-column label="银行卡" prop="userBank" width="220" >
  </el-table-column>
</el-table>
<!--分页-->
